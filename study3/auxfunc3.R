...
y<- as.matrix(cbind(y.m2010,y.f2010, y.f2011, y.f2012)) 
yt= y
...
qx_fitted = function(fit){
  ...
  qx_fitted_f2011 = t(qx_fitted[,,3])
  qx_fitted_f2012 = t(qx_fitted[,,4])
  
  colnames(qx_fitted_m2010) = colnames(qx_fitted_f2010) = colnames(qx_fitted_f2011) = colnames(qx_fitted_f2012)= c("qx.fitted", "qx.lower", "qx.upper")
  
  return(list(qx_fitted_m2010, qx_fitted_f2010, qx_fitted_f2011,qx_fitted_f2012))
